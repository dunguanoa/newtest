...
public class DataAdapter extends ArrayAdapter<DebillClass> {
    public DataAdapter(Context context, int textViewResourceID) {
        super(context, textViewResourceID);
    }

    public DataAdapter(Context context, int resource, List<DebillClass> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.activity_lane_data, null);
        }
